...
<div class="card">
    <div class="card-header">
        <h1 class="card-title">Menambahkan Calon Mahasiswa COAS</h1>
    </div>
    <div class="card-body">
        <form action="/student/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="file" class="form-label">Transkrip</label>
                <input type="file" name="file" id="file" class="form-control" placeholder="Isi Dengan file Nilai Mahasiswa" required>
            </div>
